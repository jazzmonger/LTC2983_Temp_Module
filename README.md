...
This repo is a **standalone** ESPHome device that reads **5× PT1000 RTDs** and **5× K-type thermocouples** in one multi-channel conversion cycle, with per-channel fault sensors. The board and can be adapted to other sensor combinations on unused LTC2983 channels.
